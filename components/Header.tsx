...
function Header() {
  ...
  return (
    <header className="bg-[#454545]">
      <nav
        className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-5"
        aria-label="Global"
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-10">
              ...
              <Popover.Panel className="absolute bg-white -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5">
                ...
                <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                  {callsToAction.map((item) => (
                    ...
                    >
                      <item.icon
                        className="h-5 w-5 flex-none text-[#000]"
                        aria-hidden="true"
                      />
                      {item.name}
                    </a>
          ...
          <a href="https://www.makemytrip.com/" target="blank" className="text-sm font-semibold leading-6 text-white">
            Flights
          </a>
          <a href="https://www.zoomcar.com/" target="blank" className="text-sm font-semibold leading-6 text-white">
            Car Rentals
          </a>
          <a href="https://www.getyourguide.com/" target="blank" className="text-sm font-semibold leading-6 text-white">
            Attractions
          </a>
          <a href="https://www.booking.com/city/br/gramado-br.en.html?aid=1874375;label=gramado-br-taKjL9utOkFDSFAkiyvrggS650650086230:pl:ta:p1:p2:ac:ap:neg:fi:tikwd-138480621:lp9300569:li:dec:dm:ppccp=UmFuZG9tSVYkc2RlIyh9YcWHiCDB7igBfp0yOaUwixk;ws=&gad_source=1&gclid=Cj0KCQiA1rSsBhDHARIsANB4EJZ51yiiGSCp83eeTN2P8kBCt7LcPgsp6YxIriUCjxttymBOOyf7FSQaAjUQEALw_wcB" target="blank" className="text-sm font-semibold leading-6 text-white">
            Flight + Hotel
          </a>
        </Popover.Group>
